...
-->
  ...
  <date:days>
    <date:day id="1" shorthand="Dom">Domingo</date:day>
    <date:day id="2" shorthand="Seg">Segunda-feira</date:day>
    <date:day id="3" shorthand="Ter">Terça-feira</date:day>
    <date:day id="4" shorthand="Qua">Quarta-feira</date:day>
    <date:day id="5" shorthand="Qui">Quinta-feira</date:day>
    <date:day id="6" shorthand="Sex">Sexta-feira</date:day>
    <date:day id="7" shorthand="Sab">Sábado</date:day>
  </date:days>
  
  <date:months>
    <date:month shorthand="Jan">Janeiro</date:month>
    <date:month shorthand="Fev">Fevereiro</date:month>
    <date:month shorthand="Mar">Março</date:month>
    <date:month shorthand="Abr">Abril</date:month>
    <date:month shorthand="Mai">Maio</date:month>
    <date:month shorthand="Jun">Junho</date:month>
    <date:month shorthand="Jul">Julho</date:month>
    <date:month shorthand="Ago">Agosto</date:month>
    <date:month shorthand="Set">Setembro</date:month>
    <date:month shorthand="Out">Outubro</date:month>
    <date:month shorthand="Nov">Novembro</date:month>
    <date:month shorthand="Dez">Dezembro</date:month>
  </date:months>
